...
from atpx import SearchError
from atpx.engines import ArxivEngine, LoogleEngine, OeisEngine, ZbmathEngine
...
def test_arxiv_parses_the_atom_feed() -> None:
    respx.get("https://export.arxiv.org/api/query").respond(text=_ATOM_FEED)
